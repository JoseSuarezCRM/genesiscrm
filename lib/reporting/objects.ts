...
// Detail-page route for a primary record, so report tables can link to it. The
// mapping lives in lib/record-href.ts so client components can use it too.
export { recordHref } from "@/lib/record-href"
